...
The repo contains the code to perform functional feature selection usinf a Dual Augmented Lagrangian (DAL) algorithm. The methods are presented in the following papers: ADD PAPERS 
